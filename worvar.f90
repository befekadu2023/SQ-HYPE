...
!> \{
  ...
  INTEGER :: checkindata         !<Number for running verification and validation checks: (<=0) No tests will not be performed,  
                                 !! (1-3) Perform tests with specified printout level (1 has the minimum number of printouts), 
                                 !! (4-6) Same as above but with no halt of execution if an error occured (4 has the minimum number of printouts)
