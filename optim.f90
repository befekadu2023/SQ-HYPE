...
!-------------------------------------------------------------------------------------------
SUBROUTINE linesearch_HYSS(xMinIn,xMaxIn,refPar,parPrecis,direction,stateinput,frozenstate,soilstate,aquiferstate,riverstate,lakestate,miscstate,xBest,fBest)
...
SUBROUTINE quasiNewton_algorithm(critLastVect,parLastTable,stateinput,frozenstate,soilstate,aquiferstate,riverstate,lakestate,miscstate)
  ...
  DO WHILE(gradNorm > optim%QN_flatTol)
     ...
     CALL direction_multiplier(par,parMin,parMax,parPrecis,direction,stateinput,frozenstate,soilstate,aquiferstate,riverstate,lakestate,miscstate,lambdaBest,critBest)
...
SUBROUTINE direction_multiplier(par,parMin,parMax,parPrecis,direction,stateinput,  &
  ...
  CALL linesearch_HYSS(0.0,maxLambda,par,parPrecis,direction,stateinput,frozenstate,soilstate,aquiferstate,riverstate,lakestate,miscstate,lambdaBest,critBest)
